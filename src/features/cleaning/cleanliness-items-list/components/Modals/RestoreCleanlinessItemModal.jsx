...
export function RestoreCleanlinessItemModal({
    open,
    onOpenChange,
    item,
    onConfirm,
        ...
        try {
            ...
            if (err.response?.data) {
                ...
                if (errorData.errors) {
                    ...
                    setError(fieldErrors[0] || errorData.message || "An error occurred while restoring the item");
                } else if (errorData.message) {
                    setError(errorData.message);
                } else {
                    setError("An error occurred while restoring the item");
                }
            } else {
