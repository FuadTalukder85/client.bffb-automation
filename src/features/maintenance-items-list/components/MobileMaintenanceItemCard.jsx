...
export default function MobileMaintenanceItemCard({
  item,
  serialNumber,
  onEdit,
  onArchive,
    ...
    >
      ...
      >
        <ExpandableCard.Content initialHeight={100}>
          ...
          <InfoTable>
            <InfoTable.Row label="Maintenance Item Name">
            ...
            <InfoTable.Row label="Status">
              <div className={cn("font-semibold text-right", !item.isActive ? "text-red-500" : "text-green-500")}>
