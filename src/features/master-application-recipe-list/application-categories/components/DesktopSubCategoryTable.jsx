...
export default function DesktopSubCategoryTable({
    subCategories,
    currentPage = 1,
    itemsPerPage = 10,
    totalPages = 1,
                ...
                return (
                    <div className="flex items-center justify-end gap-0 py-1 3xl:py-2.5">
                        {isActive ? (
                            <>
                                <button
                                    onClick={() => onViewChildren?.(subCategory)}
                                    title="View Sub-subcategories"
                                    aria-label="View Sub-subcategories"
                                    className="action-button flex items-center justify-center gap-1.5 font-semibold rounded-l-md rounded-r-none text-nav-highlight hover:bg-purple-200 bg-background border border-primary-shade-2 transition-colors focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                                >
                                    <LayoutGrid className="action-button-icon" />
                                </button>
                                <button
                                    onClick={() => onViewTags?.(subCategory)}
                                    title="View Tags"
                                ...
                                >
                                    <Tag className="action-button-icon" />
                                </button>
                                <button
                                    onClick={() => onEdit?.(subCategory)}
                                    title="Edit"
                                    aria-label="Edit"
                                    className="action-button flex items-center justify-center gap-1.5 font-semibold rounded-none text-base-color dark:text-nav-highlight hover:text-nav-highlight hover:bg-purple-200 bg-background border border-primary-shade-2 border-l-table-stroke transition-colors focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                                >
                                ...
                                <button
                                    ...
                                    title="Archive"
                                    aria-label="Archive"
                                    className="action-button flex items-center justify-center gap-1.5 font-semibold rounded-r-md rounded-l-none text-base-color dark:text-nav-highlight hover:text-red-600 hover:bg-red-50 bg-primary-shade-2 border border-primary-shade-2 border-l-table-stroke transition-colors focus-visible:z-10 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                                >
