...
export function UploadSubSubCategoriesModal({
  open,
  onOpenChange,
  onUpload,
  isLoading = false,
  ...
  const handleUploadClick = async () => {
    ...
    XLSX.utils.book_append_sheet(workbook, sheet, "SubSubCategories");
          ...
          <>
            <ModalHeader className="pb-4 lg:pb-2 xl:pb-2.5 2xl:pb-3 3xl:pb-4">
              ...
              <ModalDescription className="text-[8px] lg:text-[8px] xl:text-[10px] 2xl:text-xs 3xl:text-sm text-center">
                Upload a CSV or Excel file to bulk import sub-sub-categories
              </ModalDescription>
            </ModalHeader>
              ...
              <div className="space-y-2 text-center">
                <p className="text-sm font-medium">
                  {uploadResult.message ||
                    "Sub-sub-categories imported successfully"}
                </p>
              </div>
