 ...
 * Matches the structure of DesktopFinalRecipeTable using PaginatedTable
 */
export function DesktopFinalRecipeTableSkeleton({
  rows = 5,
  columnVisibility = {},
  columnPinning = {},
  columnSizing = {},
  ...
  const columns = [
    ...
    },
    {
      ...
      headerClassName: "table-head-cell",
      cell: () => <Skeleton className="w-full h-5" />,
      size: columnSizing["subSubCategory.name"] || 200,
    },
    {
      id: "tags",
      header: "Tags",
