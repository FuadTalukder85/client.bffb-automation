...
export function SyncRecipePricesModal({
  open,
  onOpenChange,
  onConfirm,
  className,
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      setError(
        getApiErrorMessage(err, "An error occurred while syncing recipe prices")
      );
    } finally {
      setIsLoading(false);
    }
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-4 md:space-y-6">
          ...
          <motion.div
            ...
            className="flex items-center justify-center w-16 md:w-10 lg:w-13! xl:w-17! 2xl:w-19! 3xl:w-24! h-16 md:h-10 lg:h-13! xl:h-17! 2xl:h-19! 3xl:h-24! text-white rounded-full bg-amber-500"
          >
          ...
          <div className="px-4 md:px-4 lg:px-4.5! xl:px-5.5! 2xl:px-6.5! 3xl:px-8! text-center">
            <p className="text-sm md:text-[8px] lg:text-[8.5px]! xl:text-[11.5px]! 2xl:text-[13px]! 3xl:text-base! font-medium text-foreground">
              This is a resource heavy task. This may take some time.
            </p>
            <p className="mt-2 text-sm md:text-[8px] lg:text-[8.5px]! xl:text-[11.5px]! 2xl:text-[13px]! 3xl:text-base! text-base-color">
              Are you sure you want to sync all BFF product prices to their associated recipes?
            </p>
          </div>
        ...
        <ModalFooter className="flex flex-row justify-center mt-6 md:mt-4 lg:mt-4.5! xl:mt-5.5! 2xl:mt-6.5! 3xl:mt-8! gap-3 md:gap-3 lg:gap-3! xl:gap-4! 2xl:gap-5! 3xl:gap-6!">
          ...
          <Button
            ...
            disabled={isLoading}
            className="flex-1 max-w-[140px] md:max-w-[140px] lg:max-w-[106px]! xl:max-w-[142px]! 2xl:max-w-[160px]! 3xl:max-w-[200px]! md:h-12 lg:h-6.5! xl:h-8.5! 2xl:h-9.5! 3xl:h-12! text-sm md:text-[8px] lg:text-[8.5px]! xl:text-[11.5px]! 2xl:text-[13px]! 3xl:text-base! bg-amber-500 hover:bg-amber-600 text-white disabled:opacity-50"
          >
            {isLoading ? (
              <>
