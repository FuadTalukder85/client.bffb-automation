...
const ProfileInfoDesktop = () => {
  ...
  return (
    <div className="3xl:p-3 2xl:p-2 xl:p-1.5 lg:p-1 3xl:rounded-2xl 2xl:rounded-xl xl:rounded-lg lg:rounded-md border border-table-stroke bg-[#F6F2FF] dark:bg-[#252130]">
      {/* <Toaster position="top-right" richColors /> */}
      <div className="flex flex-col 3xl:gap-3 2xl:gap-2 xl:gap-2 lg:gap-1.5 md:flex-row md:items-stretch">
        <div className="flex items-center justify-center 3xl:rounded-2xl 2xl:rounded-xl xl:rounded-lg lg:rounded-md bg-white dark:bg-background 3xl:w-44 2xl:w-35 xl:w-31 lg:w-24">
          <div className="relative 3xl:my-3 2xl:my-2.5 xl:my-2 lg:my-1.5 3xl:border-4 2xl:border-4 lg:border-2 border-primary/20 rounded-full">
            <button
              type="button"
              onClick={handleAvatarPick}
              disabled={!isEditingAvatar || isSavingAvatar}
              className={`3xl:size-24 2xl:size-[76px] xl:size-[68px] lg:size-[52px] rounded-full border-2 border-primary overflow-hidden bg-primary-shade-2 flex items-center justify-center ${
                isEditingAvatar ? "cursor-pointer" : "cursor-default"
              }`}
            >
              {displayAvatarUrl ? (
                <img
                ...
                <span className="text-2xl lg:text-sm xl:text-lg 2xl:text-xl 3xl:text-2xl font-semibold text-nav-highlight">
            ...
            {isEditingAvatar ? (
              <button
                ...
                className="absolute -right-1 top-1 3xl:size-7 2xl:size-5.5 xl:size-5 lg:size-4 rounded-full bg-nav-highlight text-white inline-flex items-center justify-center shadow-sm hover:opacity-90 disabled:opacity-60"
              >
                {isSavingAvatar ? (
              ...
              <button
                ...
                className="absolute -right-1 top-1 3xl:size-7 2xl:size-5.5 xl:size-5 lg:size-4 rounded-full bg-nav-highlight text-white inline-flex items-center justify-center shadow-sm hover:opacity-90"
              >
                <Pencil className="3xl:w-3.5 2xl:w-3 xl:w-3 lg:w-2.5 3xl:h-3.5 2xl:h-3 xl:h-3 lg:h-2.5" />
              </button>
            )}
        ...
        <div 
          ...
          className="relative overflow-hidden flex-1 3xl:rounded-xl 2xl:rounded-lg xl:rounded-md lg:rounded-md 3xl:p-3 2xl:p-2 xl:p-1.5 lg:p-1 bg-white dark:bg-background"
        >
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0 flex-1">
                <ProfileTextField
                  ...
                  className="3xl:text-[18px] 2xl:text-[14px] xl:text-[13px] lg:text-[10px] font-semibold text-foreground/75 dark:text-white truncate 3xl:rounded-full 2xl:rounded-lg xl:rounded-md lg:rounded-sm"
                  ...
                  placeholder="Name"
                />
                <div className="3xl:mt-1 2xl:mt-1 xl:mt-0.5 lg:mt-0 inline-flex flex-wrap items-center gap-0.5 lg:gap-0.5 xl:gap-1 2xl:gap-1.5 3xl:gap-2 rounded-full bg-[#F9F6FF] dark:bg-primary-shade-2 px-2 lg:px-2.5 xl:px-3 2xl:px-3.5 3xl:px-4 py-0.5 lg:py-0.5 xl:py-0.5 2xl:py-1 3xl:py-1.5 text-sm lg:text-[8px] xl:text-[10px] 2xl:text-xs 3xl:text-sm font-semibold text-foreground">
                  <span>{roleLabel || "Role not assigned"}</span>
                  <span className="rounded-full w-1.5 h-1.5 lg:w-0.5 xl:w-1 2xl:w-1.5 3xl:w-2 lg:h-0.5 xl:h-1 2xl:h-1.5 3xl:h-2 bg-primary inline-block"></span>
              ...
              <div className="flex items-center gap-2 lg:gap-0.5 xl:gap-1 2xl:gap-1.5 3xl:gap-2">
                ...
                >
                  ...
                  {isSavingProfile ? (
                    ...
                    <Save className="3xl:w-3 2xl:w-2.5 xl:w-2 lg:w-1.5 3xl:h-3 2xl:h-2.5 xl:h-2 lg:h-1.5" />
                  ) : (
                    <svg
                      width="11"
                      height="11"
                      ...
                      className="3xl:w-3 2xl:w-2.5 xl:w-2 lg:w-1.5 3xl:h-3 2xl:h-2.5 xl:h-2 lg:h-1.5"
                    >
                      <path
