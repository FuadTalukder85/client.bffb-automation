...
import { CircleArrowRight, Loader, ChevronRight } from "lucide-react";
...
export const DetailsHeader = ({
    ...
    const breadcrumbItems = [
        { label: "Application Lab", onClick: handleBack },
                ...
                <div className="items-center hidden gap-4 lg:gap-2 xl:gap-2.5 2xl:gap-3 3xl:gap-4 md:flex">
                    <div className="justify-end hidden w-full gap-2  md:flex ">
                        ...
                        >
                            {isUpdatingStage ? (
                                <>
                                    <Loader className="animate-spin desktop-page-btn m-0!" /> Updating Project Stage
                                </>
                            ) : (
                                <>
                                    <CircleArrowRight className="desktop-page-btn m-0!" /> Update
                                </>
                            )}
                        </Button>
                    </div>
