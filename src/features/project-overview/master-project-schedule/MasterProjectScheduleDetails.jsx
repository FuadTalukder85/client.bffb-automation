...
import { Bug, Grip, AlertCircle } from "lucide-react";
...
import { useMasterProjectScheduleDetailsLogic } from "./hooks/useMasterProjectScheduleDetailsLogic";
...
export default function MasterProjectScheduleDetails() {
    const {
        projectId,
        projectResponseData,
        isLoading,
        ...
        canReadField,
        canUpdateField,
    } = useMasterProjectScheduleDetailsLogic();
