...
export default function MobileMasterProjectScheduleCard({ 
    project, 
    serialNumber, 
    onViewDetails,
    className 
    ...
    const adaptedProject = {
        ...
        raisedDate: hasMasterProject
            ...
            : null,
        projectStartDate: hasMasterProject
            ? project.masterProject?.startDate
            : null,
        projectEndDate: hasMasterProject
            ? project.masterProject?.endDate
            : null,
        nextProductionDate: hasApplicationLab
            ? project.applicationLab?.nextProductionDate
            : null,
        lastProductionDate: hasApplicationLab
            ? project.applicationLab?.lastProductionDate
            : null,
        latestSensoryDate: hasSensoryLab
            ? project.sensoryLab?.latestDate
            : null,
        nextSensoryDate: hasSensoryLab
            ? project.sensoryLab?.nextDate
            : null,
        bdApprovalDate: hasBusinessDevelopment
            ? project.businessDevelopment?.approvalDate
            : null,
        clientSampleDeliveryDate: hasBusinessDevelopment
            ? project.businessDevelopment?.clientSampleDeliveryDate
            : null,
        ...
        bdStatus: hasBusinessDevelopment
            ...
            : "Access Denied",
        // bdPromotionStatus removed to match Figma
    };
            ...
            <ExpandableCard.Content initialHeight={140}>
                ...
                <InfoTable>
                    ...
                    <InfoTable.Row label="Project Start Date">
                        <div className="font-semibold text-right text-base-color">
                            {adaptedProject.projectStartDate 
                                ? formatDate(adaptedProject.projectStartDate)
                                : "—"}
                        </div>
                    </InfoTable.Row>

                    <InfoTable.Row label="Project End Date">
                        <div className="font-semibold text-right text-base-color">
                            {adaptedProject.projectEndDate 
                                ? formatDate(adaptedProject.projectEndDate)
                                : "—"}
                        </div>
                    </InfoTable.Row>
                    ...
                    <InfoTable.Row label="Next Production Date">
                        <div className="font-semibold text-right text-base-color">
                            {adaptedProject.nextProductionDate 
                                ? formatDate(adaptedProject.nextProductionDate)
                                : "—"}
                        </div>
                    </InfoTable.Row>
                    ...
                    <InfoTable.Row label="Last Production Date">
                        <div className="font-semibold text-right text-base-color">
                            {adaptedProject.lastProductionDate 
                                ? formatDate(adaptedProject.lastProductionDate)
                                : "—"}
                        </div>
                    </InfoTable.Row>

                    <InfoTable.Row label="Latest Sensory Date">
                        <div className="font-semibold text-right text-base-color">
                            {adaptedProject.latestSensoryDate 
                                ? formatDate(adaptedProject.latestSensoryDate)
                                : "—"}
                        </div>
                    </InfoTable.Row>

                    <InfoTable.Row label="Next Sensory Date">
                        <div className="font-semibold text-right text-base-color">
                            {adaptedProject.nextSensoryDate 
                                ? formatDate(adaptedProject.nextSensoryDate)
                                : "—"}
                        </div>
                    </InfoTable.Row>

                    <InfoTable.Row label="Business Development Approval Date">
                        <div className="font-semibold text-right text-base-color">
                            {adaptedProject.bdApprovalDate 
                                ? formatDate(adaptedProject.bdApprovalDate)
                                : "—"}
                        </div>
                    </InfoTable.Row>

                    <InfoTable.Row label="Client Sample Delivery Date">
                        <div className="font-semibold text-right text-base-color">
                            {adaptedProject.clientSampleDeliveryDate 
                                ? formatDate(adaptedProject.clientSampleDeliveryDate)
                                : "—"}
                        </div>
                    </InfoTable.Row>
