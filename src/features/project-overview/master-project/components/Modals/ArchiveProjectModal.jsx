...
export function ArchiveProjectModal({
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            let errorMessage = "An error occurred while archiving the project";
            
            if (err.response?.status === 403) {
                errorMessage = "You don't have permission to archive this project. Contact your administrator if you believe this is an error.";
