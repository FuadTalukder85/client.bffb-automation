...
import MobileProductDevelopmentCard from "./components/MobileProductDevelopmentCard";
import { ProductDevelopmentTableSkeleton } from "./components/ProductDevelopmentTableSkeleton";
import { MobileProductDevelopmentCardSkeleton } from "./components/MobileProductDevelopmentCardSkeleton";
import { useProductDevelopmentLogic } from "./hooks/useProductDevelopmentLogic";
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div className="hidden px-2 md:flex-1 md:flex md:flex-col md:min-h-0">
                            <DesktopProductDevelopmentTable
                                projects={projects}
