...
import { Rocket, Grip } from "lucide-react";
import { DetailsHeader } from "./components/Details/DetailsHeader";
import { PDNextStageModal } from "./components/Details/PDNextStageModal";
...
import { useProductDevelopmentDetailsLogic } from "./hooks/useProductDevelopmentDetailsLogic";
...
export default function ProductDevelopmentDetails() {
    const {
        projectId,
        projectResponseData,
        isLoading,
        ...
        canReadField,
        canUpdateField,
    } = useProductDevelopmentDetailsLogic();
    ...
    return (
        <section className=" flex flex-col px-0 md:pb-20  page-section-spacing min-h-[calc(100vh-6rem)]">
            ...
            <div className="flex justify-between w-full gap-6 md:pt-2">
                <DetailsFieldGroups
