...
import { Trash2, Pencil, Eye, AlertCircle } from "lucide-react";
...
export default function MobileProductDevelopmentCard({
    project,
    serialNumber,
    onViewDetails,
    className,
    ...
    const isActive = hasMasterProject ? (project.masterProject?.isActive ?? true) : true;
