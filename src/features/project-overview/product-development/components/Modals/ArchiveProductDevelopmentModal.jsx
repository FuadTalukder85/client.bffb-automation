...
export function ArchiveProductDevelopmentModal({
    open,
    onOpenChange,
    project,
    onConfirm,
        ...
        try {
            ...
            if (err.response?.data) {
                ...
                if (errorData.errors) {
                    ...
                    setError(fieldErrors[0] || errorData.message || "An error occurred while archiving the product development");
                } else if (errorData.message) {
                    setError(errorData.message);
                } else {
                    setError("An error occurred while archiving the product development");
                }
            } else {
                setError(err.message || "An error occurred while archiving the product development");
            }
        } finally {
            setIsLoading(false);
        }
            ...
            >
                ...
                <div className="flex flex-col items-center space-y-4 md:space-y-6">
                    ...
                    <p className="px-4 md:px-4 lg:px-4.5! xl:px-5.5! 2xl:px-6.5! 3xl:px-8! text-center text-sm md:text-[8px] lg:text-[8.5px]! xl:text-[11.5px]! 2xl:text-[13px]! 3xl:text-base! text-base-color">
                        Archiving this product development means all related data will be hidden from active views. You can restore it later if needed.
                    </p>
