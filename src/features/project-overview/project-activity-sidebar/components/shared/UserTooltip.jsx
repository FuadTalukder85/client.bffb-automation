...
// const UserTooltip = ({ userId, children, delay = 300 }) => {
//     const [isVisible, setIsVisible] = useState(false);
//     const [coords, setCoords] = useState({ x: 0, y: 0 });
//     const timerRef = useRef(null);
//     const triggerRef = useRef(null);
//     
//     // Only fetch user data when tooltip becomes visible and userId exists
//     const shouldFetch = isVisible && userId;
//     const { data: user, isLoading } = useUser(shouldFetch ? userId : null);
//
