...
import DesktopSensoryTable from "./components/DesktopSensoryTable";
import MobileSensoryCard from "./components/MobileSensoryCard";
import { SensoryTableSkeleton } from "./components/SensoryTableSkeleton";
import { MobileSensoryCardSkeleton } from "./components/MobileSensoryCardSkeleton";
import { useSensoryLogic } from "./hooks/useSensoryLogic";
import { sensoryStatusFilterOptions } from "./constants/projectOptions";
    ...
    <section className="flex flex-col px-0 page-section-spacing md:flex-1 md:min-h-0 min-h-[calc(100vh-6rem)]">
      ...
      <div className="flex-none hidden md:block my-1 lg:my-1.5 xl:my-2 2xl:my-3 3xl:my-4 ms-5">
        <div className="flex items-center gap-2 border-b border-border">
          {sensoryStatusFilterOptions.map((tab) => {
