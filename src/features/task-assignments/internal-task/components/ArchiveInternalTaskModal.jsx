...
import { useArchiveInternalTask } from "@/hooks/mutations";

export function ArchiveInternalTaskModal({
  open,
  onOpenChange,
  task,
  onConfirm,
  ...
  const { mutateAsync: archiveTask, isPending: isSubmitting } = useArchiveInternalTask();
