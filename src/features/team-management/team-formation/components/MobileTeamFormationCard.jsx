...
export function MobileTeamFormationCard({
  ...
  const activeTeamButtons = [
    {
      ...
      onClick: () => onView({ id: serial, name, isActive }),
      title: "View Team",
      className:
    ...
    },
    {
      ...
      onClick: () => onEdit({ id: serial, name, isActive }),
      title: "Edit Team",
      className:
    ...
    },
    {
      ...
      onClick: () => onArchive({ id: serial, name, isActive }),
      title: "Archive Team",
      className:
  ...
  return (
    ...
    >
      ...
      >
        {/* Left side - Serial/Checkbox and name */}
