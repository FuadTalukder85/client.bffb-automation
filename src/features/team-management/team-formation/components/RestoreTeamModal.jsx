...
export function RestoreTeamModal({
  open,
  onOpenChange,
  team,
  onConfirm,
      ...
      >
        ...
        <div className="flex flex-col items-center space-y-4 md:space-y-6">
          ...
          >
            <div className="flex items-center justify-center text-white rounded-full shadow-lg bg-invite-status-text shadow-purple-900/20 w-16 md:w-11 lg:w-13! xl:w-17! 2xl:w-19! 3xl:w-24! h-16 md:h-11 lg:h-13! xl:h-17! 2xl:h-19! 3xl:h-24!">
              <MdRestorePage className="w-8 md:w-5 lg:w-5.5! xl:w-7! 2xl:w-8! 3xl:w-10! h-8 md:h-5 lg:h-5.5! xl:h-7! 2xl:h-8! 3xl:h-10!" />
            </div>
          </motion.div>

          <ModalDescription className="px-4 md:px-4 lg:px-4.5! xl:px-5.5! 2xl:px-6.5! 3xl:px-8! text-center text-sm md:text-[8px] lg:text-[8.5px]! xl:text-[11.5px]! 2xl:text-[13px]! 3xl:text-base! font-medium leading-relaxed text-muted-foreground">
        ...
        <ModalFooter className="flex flex-row justify-center mt-6 md:mt-4 lg:mt-4.5! xl:mt-5.5! 2xl:mt-6.5! 3xl:mt-8! gap-3 md:gap-3 lg:gap-3! xl:gap-4! 2xl:gap-5! 3xl:gap-6!">
          ...
          <Button
            ...
            className="flex-1 max-w-[140px] md:max-w-[140px] lg:max-w-[106px]! xl:max-w-[142px]! 2xl:max-w-[160px]! 3xl:max-w-[200px]! md:h-12 lg:h-6.5! xl:h-8.5! 2xl:h-9.5! 3xl:h-12! text-sm md:text-[8px] lg:text-[8.5px]! xl:text-[11.5px]! 2xl:text-[13px]! 3xl:text-base! text-white bg-invite-status-text hover:bg-[#452278] border border-invite-status-text rounded-xl shadow-lg shadow-purple-900/20"
          >
            Confirm
          </Button>
        </ModalFooter>
