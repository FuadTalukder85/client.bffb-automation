...
export function DesktopRestoreMemberModal({
  open,
  onOpenChange,
  onConfirm,
  member,
        ...
        <div className="flex items-center justify-between gap-4 lg:gap-2.5 xl:gap-3 2xl:gap-3.5 3xl:gap-4 mb-4 lg:mb-4.5 xl:mb-5.5 2xl:mb-6.5 3xl:mb-8">
          ...
          <div>
            ...
            <p className="mt-1 text-sm lg:text-[8px] xl:text-[10px] 2xl:text-xs 3xl:text-sm text-lighter-text w-[150px] lg:w-[168px] xl:w-[224px] 2xl:w-[252px] 3xl:w-[315px]">
              Please choose which tasks to assign to the restored team member.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4 lg:gap-2.5 xl:gap-3 2xl:gap-3.5 3xl:gap-4">
            {/* Member Info Display */}
            <div className="w-full lg:w-[133px] xl:w-[177px] 2xl:w-[200px] 3xl:w-[250px] h-8 lg:h-5 xl:h-7 2xl:h-8 3xl:h-10 px-3 bg-nav-highlight/10 rounded-lg border border-gray-200 dark:border-white/10 flex items-center gap-3">
              <div className="flex items-center justify-center w-6 lg:w-3 xl:w-4 2xl:w-5 3xl:w-6 h-6 lg:h-3 xl:h-4 2xl:h-5 3xl:h-6 rounded-full bg-primary-shade-2 text-primary shrink-0 text-[10px] lg:text-[5.5px] xl:text-[7px] 2xl:text-[8px] 3xl:text-[10px] font-semibold border border-primary">
                {member?.user?.employeeId || "?"}
              </div>
              <div className="flex flex-col min-w-0">
                <p className="text-sm lg:text-[8px] xl:text-[10px] 2xl:text-xs 3xl:text-sm font-medium text-base-color truncate">
                  {memberName}
                </p>
                {memberEmail && (
                  <p className="text-[10px] lg:text-[5.5px] xl:text-[7px] 2xl:text-[8px] 3xl:text-[10px] text-base-color truncate">
                    {memberEmail}
                  </p>
                )}
              </div>
              ...
              filteredTasks.map((task, index) => (
                ...
                >
                  ...
                  <div className="flex justify-center">
                    <span
                      className={cn(
                        "px-4 py-1 text-xs font-medium rounded-full text-nav-highlight bg-primary-shade-2"
                      )}
                    >
